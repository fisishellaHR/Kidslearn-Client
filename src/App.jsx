...
import QuizAfter from "./Layout-views/App-Views/QuizAfter/Quiz.jsx";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/homepagebefore" element={<HomePageBefore />}></Route>
        ...
        <Route path="/userpersonal" element={<UserPersonal />}></Route>
